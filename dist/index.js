...
// UNUSED EXPORTS: Blob, blobFrom, blobFromSync, default, fileFromSync
...
// EXTERNAL MODULE: ./node_modules/split/index.js
var split = __nccwpck_require__(354);
...
async function run() {
  try {
    const marker = external_crypto_namespaceObject.randomBytes(16).toString('hex');

    const form = new esm_min/* FormData */.Ct();
    form.append('token', core.getInput('token'));
    form.append('asset', await (0,from/* fileFrom */.e2)(core.getInput('upload')));
